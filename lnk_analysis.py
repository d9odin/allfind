...
def convert_time(int_time):
    ...
    if int_time == 0:
        ...
        date_time = (
            datetime(1601, 1, 1, tzinfo=timezone(timedelta(minutes=mintz)))
            + timedelta(microseconds=int_time)
            + timedelta(minutes=mintz)
        )
    return date_time
...
class LnkAnalysis:
    ...
    def __creation_time(self):
        ...
        lnk_list = []
        lnk_obj = {"TimeZone": time_zone, "Target File Creation Time": creation_time}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
    ...
    def __access_time(self):
        ...
        lnk_list = []
        lnk_obj = {"TimeZone": time_zone, "Target File Access Time": acess_time}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
    ...
    def __lnk_creation_time(self):
        ...
        lnk_list = []
        lnk_obj = {"TimeZone": "SYSTEM TIME", "Link File Creation Time": str(c_time)}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
    ...
    def __lnk_access_time(self):
        ...
        lnk_list = []
        lnk_obj = {"TimeZone": "SYSTEM TIME", "Link File Last Access Time": str(a_time)}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
    ...
    def __lnk_write_time(self):
        ...
        lnk_list = []
        lnk_obj = {"TimeZone": "SYSTEM TIME", "Link File Write Time": str(w_time)}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
    ...
    def __volume(self):
        ...
        if self.__linkinfo_flag != "True":
            lnk_obj1 = {"Drivetype": "None", "Driveserialnumber": "None", "Volumelable": "None"}
            json.dumps(lnk_obj1)
            ...
            lnk_obj = {"Drivetype": "None", "Driveserialnumber": "None", "Volumelable": "None"}
            json.dumps(lnk_obj)
            lnk_list.append(lnk_obj)
    ...
    def __localbase_path(self):
        ...
        if self.__linkinfo_flag != "True":
            lnk_obj = {"Localbasepath Unicode": "None", "Localbasepath": "None"}
            json.dumps(lnk_obj)
            lnk_list.append(lnk_obj)
            ...
            lnk_obj = {
                "Localbasepath Unicode": self.__locbase_path_uni_off,
                "Localbasepath": "None",
            }
            json.dumps(lnk_obj)
            lnk_list.append(lnk_obj)
    ...
    def __common_network_relative_link(self):
        ...
        if self.__linkinfo_flag != "True":
            lnk_obj = {"NetName": "None", "DeviceName": "None", "NetworkProviderType": "None"}
            json.dumps(lnk_obj)
            lnk_list.append(lnk_obj)
        ...
        lnk_obj = {"NetName": net_name, "DeviceName": device_name, "NetworkProviderType": net_type}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
    ...
    def __droid_value(self):
        ...
        if self.__extra_data != "True":
            ...
            lnk_obj = {"Droid": "None", "DroidBirth": "None"}
            json.dumps(lnk_obj)
            lnk_list.append(lnk_obj)
        ...
        lnk_obj = {"Droid": str(droid), "DroidBirth": str(droidbirth)}
        json.dumps(lnk_obj)
        lnk_list.append(lnk_obj)
